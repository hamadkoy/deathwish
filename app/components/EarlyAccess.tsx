...
export function EarlyAccessButton({
  ...
  function ConfirmPopup() {
    ...
    return createPortal(
      <div style={ea.overlay} onClick={() => setConfirming(false)}>
        <div style={ea.box} onClick={(e) => e.stopPropagation()}>
          ...
          {eligible ? (
            <>
              ...
              <div style={ea.warning}>
                You must be signed to at least{" "}
                <b>{MIN_RUNS} runs</b> before the countdown ends.
                <br />
                <br />
                If you are short by then, <b>every signup you made is
                deleted</b> — one hour before signups open for everyone else.
              </div>
            ...
            <>
              ...
              <div style={ea.warningRed}>
                ...
                <b>{REQUIRED_CHARACTERS - characterCount}</b> more to your
                garrison, then come back.
              </div>
            </>
          )}
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 18 }}>
            <button onClick={() => setConfirming(false)} style={ea.cancel}>
              Cancel
            </button>
            ...
            <button
              ...
              title={
                eligible
                  ? "Take the bet"
                  : `Needs ${REQUIRED_CHARACTERS} characters`
              }
              style={{
